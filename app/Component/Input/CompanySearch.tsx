...
export default function CompanySearch({
  ...
  return (
    ...
    >
      <div className="flex-1 flex items-stretch sm:p-3 p-2">
      ...
      <div className="flex-1 flex sm:gap-2 max-sm:flex-col items-stretch">
        <div className="relative group flex-1 z-2 flex items-stretch sm:p-3 p-2">
          <div className="p-2 bg-white border-2 border-blue-default rounded-xl">
        ...
        <div className="relative group flex-1 z-1 flex items-stretch sm:p-3 p-2">
          <div className="p-2 bg-white border-2 border-blue-default rounded-xl">
