  ...
  return (
    <div className="w-full flex flex-col gap-5 items-center">
      ...
      <div className="flex w-full items-stretch">
        ...
        <div className="relative flex-8 h-130 shrink-0">
          <div className="absolute top-0 left-0 w-full h-full max-sm:p-2 roll">
            <div className="bg-white w-full h-full"></div>
          </div>
          <div className="absolute flex top-0 left-0 w-full h-full max-sm:p-2">
              ...
              <div className="flex-2 flex flex-col p-5 gap-5 shrink-0">
                ...
                <div className="flex-1 flex justify-center items-center move-right">
                  <p className="w-3/4 max-sm:w-full text-center font-bold text-zinc-500">
                    FUJob is a modern recruitment platform built to bridge the
                    gap between talented professionals and forward-thinking
                    companies. We believe that finding the right job – or the
                    right talent – should be simple, transparent, and efficient.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex max-sm:flex-col flex-9 h-100 max-lg:h-110 max-sm:h-auto min-w-0 items-stretch shrink-0 bg-white">
          <div className="flex-1 p-5 gap-5 flex flex-col items-start">
            ...
            <p className="flex-1 font-bold text-zinc-500 drop">
              FUJob's mission is to make recruitment fair, fast, and
              frictionless – for both talent and employers.
            </p>
            <div className="drop">
              <Link
                href="/jobs"
